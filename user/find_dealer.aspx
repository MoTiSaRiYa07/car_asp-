<%@ Page Title="" Language="C#" MasterPageFile="~/user/user1.master" AutoEventWireup="true" CodeFile="find_dealer.aspx.cs" Inherits="user_find_dealer" %>
...
<div class="loacte_dealer w3l">
    ...
    <asp:DropDownList ID="ddlcomp" runat="server" DataSourceID="SqlDataSource1" DataTextField="compname" 
                                ...
                                onselectedindexchanged="ddlcomp_SelectedIndexChanged" style="  padding: 12px 50px;  width: 100%;font-weight: normal; border: 1px solid #bdbaba;color: #848484; outline: none; font-size: 14px; float: left; margin-bottom: 2em;background: url(images/car.png) no-repeat 2% center #ffffff;">
   
   <asp:ListItem Text="-- Select a Make --" Selected="True"></asp:ListItem>
   ...
   <br /> <asp:DropDownList ID="ddlcity" runat="server" style="  padding: 12px 50px;  width: 100%;font-weight: normal; border: 1px solid #bdbaba;color: #848484; outline: none; font-size: 14px; float: left; margin-bottom: 2em;background: url(images/location.png) no-repeat 2% center #ffffff;">
    </asp:DropDownList>
						   <%--<select id="country17" name="city">
							...
							<option value="city">London</option>
								...
								<div class="locate-button">
                                    ...
                                    <asp:Button ID="btndealer" runat="server" Text="Find Delaers" 
                                        onclick="btndealer_Click" />
                            ...
                            <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource2">
								...
								<ItemTemplate>
                                  <ul class="dealers-list one">
										<li><a href="new_dealer.aspx?compid=<%#Eval("compid")%>">
                                            <asp:Label ID="lblcomp" runat="server" Text='<%#Eval("compname") %>'></asp:Label></a></li>
									  </ul>	
								</ItemTemplate>
                                </asp:ListView>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                SelectCommand="SELECT * FROM [tbl_comp] WHERE ([status] = @status2)">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="0" Name="status2" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
